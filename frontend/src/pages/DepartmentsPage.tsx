        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 outline-none focus:border-cyan-600 focus:ring-4 focus:ring-cyan-600/10"
            >
              ...
              <table className="w-full min-w-[850px] text-left">
                <thead className="bg-slate-50 text-xs uppercase tracking-wider text-slate-500">
                  <tr>
                    ...
                    <th className="px-5 py-4">Salas</th>
                      ...
                      {isAdmin && (
                        <td className="px-5 py-4 text-right">
                          <button
                            ...
                            className="rounded-lg border border-slate-200 px-3 py-2 text-xs font-medium text-slate-600 transition hover:border-cyan-300 hover:text-cyan-700 disabled:opacity-50"
                          >
                            {department.isActive
                              ? 'Desactivar'
                              : 'Activar'}
